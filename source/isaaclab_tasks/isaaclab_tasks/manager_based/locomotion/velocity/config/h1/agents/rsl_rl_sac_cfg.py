...
@configclass
class H1RoughSACRunnerCfg(RslRlOffPolicyRunnerCfg):
    """Default SAC configuration for the rough H1 task."""
...
@configclass
class H1FlatSACRunnerCfg(H1RoughSACRunnerCfg):
    """Default SAC configuration for the flat H1 task."""
