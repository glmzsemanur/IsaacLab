...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_sac_cfg_entry_point": f"{agents.__name__}.rsl_rl_sac_cfg:CassieFlatSACRunnerCfg",
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_sac_cfg_entry_point": f"{agents.__name__}.rsl_rl_sac_cfg:CassieRoughSACRunnerCfg",
