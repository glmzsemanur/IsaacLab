...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_sac_cfg_entry_point": f"{agents.__name__}.rsl_rl_sac_cfg:UnitreeA1FlatSACRunnerCfg",
...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_sac_cfg_entry_point": f"{agents.__name__}.rsl_rl_sac_cfg:UnitreeA1RoughSACRunnerCfg",
