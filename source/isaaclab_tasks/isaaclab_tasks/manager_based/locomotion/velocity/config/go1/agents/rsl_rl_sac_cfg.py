...
@configclass
class UnitreeGo1RoughSACRunnerCfg(RslRlOffPolicyRunnerCfg):
    """Default SAC configuration for the rough Unitree Go1 task."""
...
@configclass
class UnitreeGo1FlatSACRunnerCfg(UnitreeGo1RoughSACRunnerCfg):
    """Default SAC configuration for the flat Unitree Go1 task."""
