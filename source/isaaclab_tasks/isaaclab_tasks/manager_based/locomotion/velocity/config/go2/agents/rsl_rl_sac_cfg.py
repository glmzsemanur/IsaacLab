...
@configclass
class UnitreeGo2RoughSACRunnerCfg(RslRlOffPolicyRunnerCfg):
    """Default SAC configuration for the rough Unitree Go2 task."""
...
@configclass
class UnitreeGo2FlatSACRunnerCfg(UnitreeGo2RoughSACRunnerCfg):
    """Default SAC configuration for the flat Unitree Go2 task."""
