...
@configclass
class CassieRoughSACRunnerCfg(RslRlOffPolicyRunnerCfg):
    """Default SAC configuration for the rough Cassie task."""
...
@configclass
class CassieFlatSACRunnerCfg(CassieRoughSACRunnerCfg):
    """Default SAC configuration for the flat Cassie task."""
